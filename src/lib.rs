...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SpaceStation processing");
    
    let mut processor = SpaceStationProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SpaceStationProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SpaceStationProcessor::new(false);
